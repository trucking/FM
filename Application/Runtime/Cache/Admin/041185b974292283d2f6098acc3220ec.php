...
<head>
    ...
    <link href="/fm/Application/Admin/View/media/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
    <link href="/fm/Application/Admin/View/media/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
    ...
    <link href="/fm/Application/Admin/View/media/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css" />
...
<div class="user-login-5">
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset mt-login-5-bsfix">
            <div class="login-bg" style="background-image:url(/fm/Application/Admin/View/media/assets/pages/img/login/bg1.jpg)">
                <img class="login-logo" src="/fm/Application/Admin/View/media/assets/pages/img/login/logo.png" />
            </div>
        </div>
...
<!-- END : LOGIN PAGE 5-1 -->
<!--[if lt IE 9]>
<script src="/fm/Application/Admin/View/media/assets/global/plugins/respond.min.js"></script>
<script src="/fm/Application/Admin/View/media/assets/global/plugins/excanvas.min.js"></script>
<script src="/fm/Application/Admin/View/media/assets/global/plugins/ie8.fix.min.js"></script>
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="/fm/Application/Admin/View/media/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="/fm/Application/Admin/View/media/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
<script src="/fm/Application/Admin/View/media/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
<script src="/fm/Application/Admin/View/media/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="/fm/Application/Admin/View/media/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="/fm/Application/Admin/View/media/assets/pages/scripts/login-5.js" type="text/javascript"></script>
