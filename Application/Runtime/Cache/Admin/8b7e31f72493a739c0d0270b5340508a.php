...
<div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="start">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="start active" href="/fm/admin.php/index/companyConf">组织管理</a>
                    </li>
                    <li>
                        <a href="/fm/admin.php/index/userManage">用户管理</a>
                    </li>
                    <li>
                        <a href="#">权限管理</a>
                    </li>
            ...
            <li class="">
                <a href="/fm/admin.php/index/busManage">
                    <i class="icon-cut"></i>
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="page-title">公司名称修改<small>修改公司名称</small></div>
                <div class="alert alert-block alert-success fade in">
                    <button class="close" type="button" data-dismiss="alert"></button>
                    <h3 class="alert-heading"><?php echo ($name["0"]["name"]); ?></h3>
                ...
                <p>
                    <a class="btn green" href="/fm/admin.php/index/userManage">修改</a>
                </p>
                </div>
            </div>
        </div>
